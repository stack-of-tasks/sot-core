...
Add_of_matrix('')
from binary_op import Add_of_double
Add_of_double('')
from binary_op import Multiply_of_vector
Multiply_of_vector('')
...
from binary_op import Multiply_of_quaternion
Multiply_of_quaternion('')
from binary_op import Multiply_of_double
Multiply_of_double('')
from binary_op import Substract_of_vector
Substract_of_vector('')
from binary_op import Substract_of_matrix
Substract_of_matrix('')
from binary_op import Substract_of_double
Substract_of_double('')
